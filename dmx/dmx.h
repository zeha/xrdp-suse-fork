...
struct mod
{
  ...
  int (*server_set_login_mode)(struct mod* v, int login_mode);
  ...
  int x11_client_sck;
  tbus x11_client_sck_obj;
  int x11_client_sck_closed;
  int pipefd;
  unsigned int inflate_level;
